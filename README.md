...
[![SCSS/SASS](https://img.shields.io/badge/SCSS/SASS-CC6699?logo=sass&logoColor=white)](https://sass-lang.com/)
...
<details>
  <summary>🎖️ Сертификаты (раскрыть список)</summary>

1. **HTML‑вёрстка** — основы семантической разметки, работа с HTML5 
